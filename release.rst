...
- Supported FortiManager 7.4.3. 33 new modules.
...
- fortinet.fortimanager.fmgr_extendercontroller_extender - Extender controller extender
- fortinet.fortimanager.fmgr_extendercontroller_extender_controllerreport - FortiExtender controller report configuration.
- fortinet.fortimanager.fmgr_extendercontroller_extender_modem1 - Configuration options for modem 1.
- fortinet.fortimanager.fmgr_extendercontroller_extender_modem1_autoswitch - FortiExtender auto switch configuration.
- fortinet.fortimanager.fmgr_extendercontroller_extender_modem2 - Configuration options for modem 2.
- fortinet.fortimanager.fmgr_extendercontroller_extender_modem2_autoswitch - FortiExtender auto switch configuration.
- fortinet.fortimanager.fmgr_extendercontroller_extender_wanextension - Extender controller extender wan extension
- fortinet.fortimanager.fmgr_extensioncontroller_extender - Extender controller configuration.
- fortinet.fortimanager.fmgr_extensioncontroller_extender_wanextension - FortiExtender wan extension configuration.
...
- fortinet.fortimanager.fmgr_fsp_managedswitch - Require device/vdom scope member
- fortinet.fortimanager.fmgr_fsp_packetcapture - Require device/vdom scope member
- fortinet.fortimanager.fmgr_fsp_packetcapture_firewallsniffer - Configure sniffer.
- fortinet.fortimanager.fmgr_fsp_packetcapture_targetip - Sniffer IPs to filter.
- fortinet.fortimanager.fmgr_fsp_packetcapture_targetmac - Sniffer MACs to filter.
- fortinet.fortimanager.fmgr_fsp_packetcapture_targetport - Sniffer ports to filter.
- fortinet.fortimanager.fmgr_fsp_vdomsettings - Require device/vdom scope member
- fortinet.fortimanager.fmgr_fsp_vdomsettings_interfacesettings - Require device/vdom scope member
- fortinet.fortimanager.fmgr_pkg_firewall_hyperscalepolicy_sectionvalue - Configure IPv4/IPv6 policies.
...
- fortinet.fortimanager.fmgr_wireless_wtp - Configure Wireless Termination Points
- fortinet.fortimanager.fmgr_wireless_wtp_lan - WTP LAN port mapping.
- fortinet.fortimanager.fmgr_wireless_wtp_radio1 - Configuration options for radio 1.
- fortinet.fortimanager.fmgr_wireless_wtp_radio2 - Configuration options for radio 2.
- fortinet.fortimanager.fmgr_wireless_wtp_radio3 - Configuration options for radio 3.
- fortinet.fortimanager.fmgr_wireless_wtp_radio4 - Configuration options for radio 4.
- fortinet.fortimanager.fmgr_wireless_wtp_splittunnelingacl - Split tunneling ACL filter list.
- fortinet.fortimanager.fmgr_wireless_wtpgroup - Configure WTP groups.
