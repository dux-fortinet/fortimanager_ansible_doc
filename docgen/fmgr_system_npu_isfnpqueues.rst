:source: fmgr_system_npu_isfnpqueues.py

:orphan:

.. _fmgr_system_npu_isfnpqueues:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_isfnpqueues</span> - Configure queues of switch port connected to NP6 XAUI on ingress path. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
