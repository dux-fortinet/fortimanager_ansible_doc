:source: fmgr_firewall_accessproxy6_apigateway_realservers.py

:orphan:

.. _fmgr_firewall_accessproxy6_apigateway_realservers:
...
.. raw:: html
 ...
 <li><span class="li-head">api-gateway</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">firewall_accessproxy6_apigateway_realservers</span> - Select the real servers that this Access Proxy will distribute traffic to. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
