...
.. raw:: html
 ...
 <li><span class="li-head">expire</span> Time in seconds before guest user accounts expire. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">group</span> Guest name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">group_name</span> <b>(Alias name: group-name)</b>  Name of matching group on remote authentication server. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">logic_type</span> <b>(Alias name: logic-type)</b>  Set the logic between members or matching entries. <span class="li-normal">type: str</span> <span class="li-normal">choices: [or, and]</span> 
