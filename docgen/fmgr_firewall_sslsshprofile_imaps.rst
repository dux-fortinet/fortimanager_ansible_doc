:source: fmgr_firewall_sslsshprofile_imaps.py

:orphan:

.. _fmgr_firewall_sslsshprofile_imaps:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_sslsshprofile_imaps</span> - Configure IMAPS options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
