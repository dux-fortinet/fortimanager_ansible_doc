:source: fmgr_firewall_internetserviceaddition_entry.py

:orphan:

.. _fmgr_firewall_internetserviceaddition_entry:
...
.. raw:: html
 ...
 <li><span class="li-head">internet-service-addition</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">firewall_internetserviceaddition_entry</span> - Entries added to the Internet Service addition database. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
