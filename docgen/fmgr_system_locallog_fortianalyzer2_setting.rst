:source: fmgr_system_locallog_fortianalyzer2_setting.py

:orphan:

.. _fmgr_system_locallog_fortianalyzer2_setting:
...
.. raw:: html
 ...
 <li><span class="li-head">system_locallog_fortianalyzer2_setting</span> - Settings for locallog to fortianalyzer. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">upload_time</span> <b>(Alias name: upload-time)</b>  Time to upload local log files (hh:mm). <span class="li-normal">type: list</span>
 <a id='label10' href="javascript:ContentClick('label11', 'label10');" onmouseover="ContentPreview('label11');" onmouseout="ContentUnpreview('label11');" title="click to collapse or expand..."> more... </a>
 <div id="label11" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">server</span> Remote fortianalyzer server fqdn, hostname, or ip address <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">peer_cert_cn</span> <b>(Alias name: peer-cert-cn)</b>  Certificate common name of remote fortianalyzer. <span class="li-normal">type: str</span>
