:source: fmgr_system_log_settings_rollinganalyzer.py
...
.. raw:: html
 ...
 <li><span class="li-head">system_log_settings_rollinganalyzer</span> - Log rolling policy for Network Analyzer logs. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
