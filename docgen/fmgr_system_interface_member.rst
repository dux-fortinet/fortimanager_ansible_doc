:source: fmgr_system_interface_member.py

:orphan:

.. _fmgr_system_interface_member:
...
.. raw:: html
 ...
 <li><span class="li-head">system_interface_member</span> - Physical interfaces that belong to the aggregate or redundant interface. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
