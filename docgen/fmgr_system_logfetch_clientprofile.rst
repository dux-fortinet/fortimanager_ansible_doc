...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">client_adom</span> <b>(Alias name: client-adom)</b>  Log-fetch client sides adom name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">device_filter</span> <b>(Alias name: device-filter)</b>  Device filter. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">end_time</span> <b>(Alias name: end-time)</b>  End date and time of the data-range <hh:mm yyyy/mm/dd>. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">log_filter</span> <b>(Alias name: log-filter)</b>  Log filter. <span class="li-normal">type: list</span>
 <a id='label22' href="javascript:ContentClick('label23', 'label22');" onmouseover="ContentPreview('label23');" onmouseout="ContentUnpreview('label23');" title="click to collapse or expand..."> more... </a>
 <div id="label23" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> v7.2.1</code></p>
 </div>
 <ul class="ul-self">
 <li><span class="li-head">field</span> Field name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">value</span> Field filter operand or free-text matching expression. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">name</span> Name of log-fetch client profile. <span class="li-normal">type: str</span>
 <a id='label36' href="javascript:ContentClick('label37', 'label36');" onmouseover="ContentPreview('label37');" onmouseout="ContentUnpreview('label37');" title="click to collapse or expand..."> more... </a>
 <div id="label37" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> v7.2.1</code></p>
 </div>
 </li>
 <li><span class="li-head">password</span> Log-fetch server login password. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">server_adom</span> <b>(Alias name: server-adom)</b>  Log-fetch server sides adom name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">start_time</span> <b>(Alias name: start-time)</b>  Start date and time of the data-range <hh:mm yyyy/mm/dd>. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">user</span> Log-fetch server login username. <span class="li-normal">type: str</span>
 <a id='label50' href="javascript:ContentClick('label51', 'label50');" onmouseover="ContentPreview('label51');" onmouseout="ContentUnpreview('label51');" title="click to collapse or expand..."> more... </a>
 <div id="label51" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> v7.2.1</code></p>
 </div>
 </li>
 <li><span class="li-head">peer_cert_cn</span> <b>(Alias name: peer-cert-cn)</b>  Certificate common name of log-fetch server. <span class="li-normal">type: str</span>
