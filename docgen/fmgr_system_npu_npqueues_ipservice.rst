:source: fmgr_system_npu_npqueues_ipservice.py

:orphan:

.. _fmgr_system_npu_npqueues_ipservice:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_npqueues_ipservice</span> - Configure a NP7 QoS IP Service. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
