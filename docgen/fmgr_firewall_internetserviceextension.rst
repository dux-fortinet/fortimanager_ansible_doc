:source: fmgr_firewall_internetserviceextension.py

:orphan:

.. _fmgr_firewall_internetserviceextension:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_internetserviceextension</span> - Configure Internet Services Extension. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <ul class="ul-self">
 <li><span class="li-head">end_ip</span> <b>(Alias name: end-ip)</b>  End ipv4 address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">start_ip</span> <b>(Alias name: start-ip)</b>  Start ipv4 address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ip6_range</span> <b>(Alias name: ip6-range)</b>  Ip6 range. <span class="li-normal">type: list</span>
 <a id='label16' href="javascript:ContentClick('label17', 'label16');" onmouseover="ContentPreview('label17');" onmouseout="ContentUnpreview('label17');" title="click to collapse or expand..."> more... </a>
 <div id="label17" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.7 -> v7.4.7</code></p>
 </div>
 <ul class="ul-self">
 <li><span class="li-head">end_ip6</span> <b>(Alias name: end-ip6)</b>  End ipv6 address. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">start_ip6</span> <b>(Alias name: start-ip6)</b>  Start ipv6 address. <span class="li-normal">type: str</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">end_port</span> <b>(Alias name: end-port)</b>  Ending tcp/udp/sctp destination port (0 to 65535). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">start_port</span> <b>(Alias name: start-port)</b>  Starting tcp/udp/sctp destination port (0 to 65535). <span class="li-normal">type: int</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">end_port</span> <b>(Alias name: end-port)</b>  Integer value for ending tcp/udp/sctp destination port in range (0 to 65535). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">start_port</span> <b>(Alias name: start-port)</b>  Integer value for starting tcp/udp/sctp destination port in range (0 to 65535). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">id</span> Internet service id in the internet service database. <span class="li-normal">type: list</span>
