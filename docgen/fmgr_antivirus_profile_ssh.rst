:source: fmgr_antivirus_profile_ssh.py

:orphan:

.. _fmgr_antivirus_profile_ssh:
...
.. raw:: html
 ...
 <li><span class="li-head">antivirus_profile_ssh</span> - Configure SFTP and SCP AntiVirus options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
