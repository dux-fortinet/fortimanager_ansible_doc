:source: fmgr_telemetrycontroller_agentprofile.py

:orphan:

.. _fmgr_telemetrycontroller_agentprofile:
...
.. raw:: html
 ...
 <li><span class="li-head">telemetrycontroller_agentprofile</span> - Configure FortiTelemetry agent profiles. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">model</span> Model. <span class="li-normal">type: str</span> <span class="li-normal">choices: [FTL100G, WINDOWS, ftl-100g, windows, macos]</span>
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.3 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">name</span> Name of the agent profile. <span class="li-normal">type: str</span>
