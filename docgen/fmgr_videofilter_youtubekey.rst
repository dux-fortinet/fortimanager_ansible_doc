:source: fmgr_videofilter_youtubekey.py

:orphan:

.. _fmgr_videofilter_youtubekey:
...
.. raw:: html
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.2 -> v7.4.3</code>, <code class="docutils literal notranslate">v7.6.0 -> v7.6.1</code></p>
...
.. raw:: html
 ...
 <li><span class="li-head">videofilter_youtubekey</span> - Configure YouTube API keys. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
