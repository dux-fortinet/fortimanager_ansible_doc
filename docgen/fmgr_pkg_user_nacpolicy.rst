:source: fmgr_pkg_user_nacpolicy.py

:orphan:

.. _fmgr_pkg_user_nacpolicy:
...
.. raw:: html
 ...
 <li><span class="li-head">ems_tag</span> <b>(Alias name: ems-tag)</b>  Nac policy matching ems tag. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">hw_vendor</span> <b>(Alias name: hw-vendor)</b>  Nac policy matching hardware vendor. <span class="li-normal">type: str</span>
 <a id='label10' href="javascript:ContentClick('label11', 'label10');" onmouseover="ContentPreview('label11');" onmouseout="ContentUnpreview('label11');" title="click to collapse or expand..."> more... </a>
 <div id="label11" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">hw_version</span> <b>(Alias name: hw-version)</b>  Nac policy matching hardware version. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">name</span> Nac policy name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">ssid_policy</span> <b>(Alias name: ssid-policy)</b>  Ssid policy to be applied on the matched nac policy. <span class="li-normal">type: str</span>
 <a id='label22' href="javascript:ContentClick('label23', 'label22');" onmouseover="ContentPreview('label23');" onmouseout="ContentUnpreview('label23');" title="click to collapse or expand..."> more... </a>
 <div id="label23" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">status</span> Enable/disable nac policy. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 <a id='label24' href="javascript:ContentClick('label25', 'label24');" onmouseover="ContentPreview('label25');" onmouseout="ContentUnpreview('label25');" title="click to collapse or expand..."> more... </a>
 <div id="label25" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">sw_version</span> <b>(Alias name: sw-version)</b>  Nac policy matching software version. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">user_group</span> <b>(Alias name: user-group)</b>  Nac policy matching user group. <span class="li-normal">type: str</span>
