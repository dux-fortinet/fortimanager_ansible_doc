:source: fmgr_switchcontroller_acl_group.py

:orphan:

.. _fmgr_switchcontroller_acl_group:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_acl_group</span> - Configure ACL groups to be applied on managed FortiSwitch ports. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">ingress</span> Configure ingress acl policies in group. <span class="li-normal">type: list</span>
