:source: fmgr_firewall_sslsshprofile_ftps.py

:orphan:

.. _fmgr_firewall_sslsshprofile_ftps:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_sslsshprofile_ftps</span> - Configure FTPS options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
