...
.. raw:: html
 ...
 <li><span class="li-head">password</span> Group password. <span class="li-normal">type: list</span>
 <a id='label10' href="javascript:ContentClick('label11', 'label10');" onmouseover="ContentPreview('label11');" onmouseout="ContentUnpreview('label11');" title="click to collapse or expand..."> more... </a>
 <div id="label11" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">peer</span> Peer. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">serial_number</span> <b>(Alias name: serial-number)</b>  Serial number of peer. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">local_cert</span> <b>(Alias name: local-cert)</b>  Set the ha local certificate. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">monitored_interfaces</span> <b>(Alias name: monitored-interfaces)</b>  Monitored interfaces. <span class="li-normal">type: list</span>
 <a id='label28' href="javascript:ContentClick('label29', 'label28');" onmouseover="ContentPreview('label29');" onmouseout="ContentUnpreview('label29');" title="click to collapse or expand..."> more... </a>
 <div id="label29" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.0 -> latest</code></p>
 </div>
 <ul class="ul-self">
 <li><span class="li-head">interface_name</span> <b>(Alias name: interface-name)</b>  Interface name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">monitored_ips</span> <b>(Alias name: monitored-ips)</b>  Monitored ips. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">vip</span> Virtual ip. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">vrrp_interface</span> <b>(Alias name: vrrp-interface)</b>  Vrrp and vip interface. <span class="li-normal">type: str</span>
