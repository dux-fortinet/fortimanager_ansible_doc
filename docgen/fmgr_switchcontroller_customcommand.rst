:source: fmgr_switchcontroller_customcommand.py

:orphan:

.. _fmgr_switchcontroller_customcommand:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_customcommand</span> - Configure the FortiGate switch controller to send custom commands to managed FortiSwitch devices. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">command</span> String of commands to send to fortiswitch devices (for example (0x0. <span class="li-normal">type: str</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">command_name</span> <b>(Alias name: command-name)</b>  Command name called by the fortigate switch controller in the execute command. <span class="li-normal">type: str</span>
