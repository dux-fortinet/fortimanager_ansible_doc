:source: fmgr_firewall_explicitproxyaddress.py

:orphan:

.. _fmgr_firewall_explicitproxyaddress:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_explicitproxyaddress</span> - Explicit web proxy address configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">host_regex</span> <b>(Alias name: host-regex)</b>  Host regular expression. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">path</span> Url path regular expression. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">type</span> Address type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [host-regex, url, category, method, ua, header, src-advanced, dst-advanced]</span> 
