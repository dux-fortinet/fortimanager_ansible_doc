:source: fmgr_antivirus_profile_smtp.py

:orphan:

.. _fmgr_antivirus_profile_smtp:
...
.. raw:: html
 ...
 <li><span class="li-head">antivirus_profile_smtp</span> - Configure SMTP AntiVirus options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
