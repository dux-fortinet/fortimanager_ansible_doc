:source: fmgr_system_locallog_syslogd2_setting.py

:orphan:

.. _fmgr_system_locallog_syslogd2_setting:
...
.. raw:: html
 ...
 <li><span class="li-head">system_locallog_syslogd2_setting</span> - Settings for remote syslog server. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">syslog_name</span> <b>(Alias name: syslog-name)</b>  Remote syslog server name. <span class="li-normal">type: str</span>
 <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
 <div id="label9" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">cert</span> Select local certificate used for secure connection. <span class="li-normal">type: str</span>
