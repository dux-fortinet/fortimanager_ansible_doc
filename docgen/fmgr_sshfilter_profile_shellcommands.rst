:source: fmgr_sshfilter_profile_shellcommands.py

:orphan:

.. _fmgr_sshfilter_profile_shellcommands:
...
.. raw:: html
 ...
 <li><span class="li-head">sshfilter_profile_shellcommands</span> - SSH command filter. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
