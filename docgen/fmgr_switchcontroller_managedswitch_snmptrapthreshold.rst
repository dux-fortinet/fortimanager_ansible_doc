:source: fmgr_switchcontroller_managedswitch_snmptrapthreshold.py

:orphan:

.. _fmgr_switchcontroller_managedswitch_snmptrapthreshold:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_managedswitch_snmptrapthreshold</span> - Configuration method to edit Simple Network Management Protocol <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
