:source: fmgr_pm_config_pblock_firewall_localinpolicy6.py

:orphan:

.. _fmgr_pm_config_pblock_firewall_localinpolicy6:
...
.. raw:: html
 ...
 <li><span class="li-head">pm_config_pblock_firewall_localinpolicy6</span> - Configure user defined IPv6 local-in policies. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
