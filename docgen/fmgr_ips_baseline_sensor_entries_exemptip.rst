:source: fmgr_ips_baseline_sensor_entries_exemptip.py

:orphan:

.. _fmgr_ips_baseline_sensor_entries_exemptip:
...
.. raw:: html
 ...
 <li><span class="li-head">ips_baseline_sensor_entries_exemptip</span> - Traffic from selected source or destination IP addresses is exempt from this signature. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
