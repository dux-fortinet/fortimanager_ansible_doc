:source: fmgr_system_virtualwirepair.py
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">member</span> Interfaces belong to the virtual-wire-pair. <span class="li-normal">type: list or str</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">name</span> Virtual-wire-pair name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">wildcard_vlan</span> <b>(Alias name: wildcard-vlan)</b>  Enable/disable wildcard vlan. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
