:source: fmgr_fsp_vlan_dynamicmapping_interface_vrrp.py

:orphan:

.. _fmgr_fsp_vlan_dynamicmapping_interface_vrrp:
...
.. raw:: html
 ...
 <li><span class="li-head">fsp_vlan_dynamicmapping_interface_vrrp</span> - VRRP configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
