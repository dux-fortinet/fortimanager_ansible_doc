:source: fmgr_system_npu_portpathoption.py

:orphan:

.. _fmgr_system_npu_portpathoption:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_portpathoption</span> - Configure port using NPU or Intel-NIC. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
