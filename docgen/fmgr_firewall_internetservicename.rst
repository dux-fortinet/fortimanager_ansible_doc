:source: fmgr_firewall_internetservicename.py

:orphan:

.. _fmgr_firewall_internetservicename:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_internetservicename</span> - Define internet service names. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">city_id</span> <b>(Alias name: city-id)</b>  City id. <span class="li-normal">type: int</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.4.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">country_id</span> <b>(Alias name: country-id)</b>  Country or area id. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">region_id</span> <b>(Alias name: region-id)</b>  Region id. <span class="li-normal">type: int</span>
