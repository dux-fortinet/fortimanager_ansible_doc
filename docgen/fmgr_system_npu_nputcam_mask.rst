:source: fmgr_system_npu_nputcam_mask.py

:orphan:

.. _fmgr_system_npu_nputcam_mask:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_nputcam_mask</span> - Mask fields of TCAM. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
