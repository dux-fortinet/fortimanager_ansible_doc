:source: fmgr_switchcontroller_lldpprofile.py
...
.. raw:: html
 ...
 <li><span class="li-head">auto_isl_hello_timer</span> <b>(Alias name: auto-isl-hello-timer)</b>  Auto inter-switch lag hello timer duration (1 - 30 sec, default = 3). <span class="li-normal">type: int</span>
 <a id='label6' href="javascript:ContentClick('label7', 'label6');" onmouseover="ContentPreview('label7');" onmouseout="ContentUnpreview('label7');" title="click to collapse or expand..."> more... </a>
 <div id="label7" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">auto_isl_port_group</span> <b>(Alias name: auto-isl-port-group)</b>  Auto inter-switch lag port group id (0 - 9). <span class="li-normal">type: int</span>
 <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
 <div id="label9" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">auto_isl_receive_timeout</span> <b>(Alias name: auto-isl-receive-timeout)</b>  Auto inter-switch lag timeout if no response is received (3 - 90 sec, default = 9). <span class="li-normal">type: int</span>
 ...
 <ul class="ul-self">
 <li><span class="li-head">information_string</span> <b>(Alias name: information-string)</b>  Organizationally defined information string (0 - 507 hexadecimal bytes). <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">vlan_intf</span> <b>(Alias name: vlan-intf)</b>  Vlan interface to advertise; if configured on port. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">sys_location_id</span> <b>(Alias name: sys-location-id)</b>  Location service id. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">auto_isl_auth_identity</span> <b>(Alias name: auto-isl-auth-identity)</b>  Auto inter-switch lag authentication identity. <span class="li-normal">type: str</span>
 <a id='label56' href="javascript:ContentClick('label57', 'label56');" onmouseover="ContentPreview('label57');" onmouseout="ContentUnpreview('label57');" title="click to collapse or expand..."> more... </a>
 <div id="label57" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">auto_isl_auth_macsec_profile</span> <b>(Alias name: auto-isl-auth-macsec-profile)</b>  Auto inter-switch lag macsec profile for encryption. <span class="li-normal">type: str</span>
 <a id='label58' href="javascript:ContentClick('label59', 'label58');" onmouseover="ContentPreview('label59');" onmouseout="ContentUnpreview('label59');" title="click to collapse or expand..."> more... </a>
 <div id="label59" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">auto_isl_auth_reauth</span> <b>(Alias name: auto-isl-auth-reauth)</b>  Auto inter-switch lag authentication reauth period in seconds(10 - 3600, default = 3600). <span class="li-normal">type: int</span>
 <a id='label60' href="javascript:ContentClick('label61', 'label60');" onmouseover="ContentPreview('label61');" onmouseout="ContentUnpreview('label61');" title="click to collapse or expand..."> more... </a>
 <div id="label61" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">auto_isl_auth_user</span> <b>(Alias name: auto-isl-auth-user)</b>  Auto inter-switch lag authentication user certificate. <span class="li-normal">type: str</span>
