:source: fmgr_firewall_customtag.py

:orphan:

.. _fmgr_firewall_customtag:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_customtag</span> - Define custom tag table. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">name</span> Custom tag name. <span class="li-normal">type: str</span>
