:source: fmgr_firewall_profileprotocoloptions_mapi.py

:orphan:

.. _fmgr_firewall_profileprotocoloptions_mapi:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_profileprotocoloptions_mapi</span> - Configure MAPI protocol options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
