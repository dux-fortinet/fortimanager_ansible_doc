:source: fmgr_firewall_internetserviceaddition_entry_portrange.py

:orphan:

.. _fmgr_firewall_internetserviceaddition_entry_portrange:
...
.. raw:: html
 ...
 <li><span class="li-head">internet_service_addition</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 ...
 <li><span class="li-head">firewall_internetserviceaddition_entry_portrange</span> - Port ranges in the custom entry. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
