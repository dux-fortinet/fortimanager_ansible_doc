:source: fmgr_cloud_orchestawstemplate_autoscaletgwnewvpc.py

:orphan:

.. _fmgr_cloud_orchestawstemplate_autoscaletgwnewvpc:
...
.. raw:: html
 ...
 <li><span class="li-head">cloud_orchestawstemplate_autoscaletgwnewvpc</span> - Cloud orchest awstemplate autoscale tgw new vpc <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">bgp_asn</span> <b>(Alias name: bgp-asn)</b>  Bgp asn. <span class="li-normal">type: int</span> <span class="li-normal">default: 65000</span> 
 ...
 <li><span class="li-head">transit_gateway_id</span> <b>(Alias name: transit-gateway-id)</b>  Transit gateway id. <span class="li-normal">type: str</span>
 <a id='label84' href="javascript:ContentClick('label85', 'label84');" onmouseover="ContentPreview('label85');" onmouseout="ContentUnpreview('label85');" title="click to collapse or expand..."> more... </a>
 <div id="label85" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">transit_gateway_support_options</span> <b>(Alias name: transit-gateway-support-options)</b>  Transit gateway support options. <span class="li-normal">type: str</span> <span class="li-normal">choices: [create one, use an existing one]</span>  <span class="li-normal">default: create one</span> 
