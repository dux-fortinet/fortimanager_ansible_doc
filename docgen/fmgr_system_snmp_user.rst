...
.. raw:: html
 ...
 <li><span class="li-head">notify_hosts</span> <b>(Alias name: notify-hosts)</b>  Hosts to send notifications (traps) to. <span class="li-normal">type: str</span>
 <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
 <div id="label9" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">notify_hosts6</span> <b>(Alias name: notify-hosts6)</b>  Ipv6 hosts to send notifications (traps) to. <span class="li-normal">type: str</span>
