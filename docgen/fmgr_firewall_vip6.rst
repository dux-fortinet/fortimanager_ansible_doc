...
.. raw:: html
 ...
 <li><span class="li-head">vip_id</span> <b>(Alias name: vip-id)</b>  Vip id. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">name</span> Virtual ip6 name. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">server_type</span> <b>(Alias name: server-type)</b>  Protocol to be load balanced by the virtual server (also called the server load balance virtual ip). <span class="li-normal">type: str</span> <span class="li-normal">choices: [http, https, ssl, tcp, udp, ip, imaps, pop3s, smtps]</span> 
 ...
 <li><span class="li-head">src_filter</span> <b>(Alias name: src-filter)</b>  Source ip6 filter (x:x:x:x:x:x:x:x/x). <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">ssl_hpkp_age</span> <b>(Alias name: ssl-hpkp-age)</b>  Number of minutes the web browser should keep hpkp. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">type</span> Configure a static nat vip. <span class="li-normal">type: str</span> <span class="li-normal">choices: [static-nat, server-load-balance, access-proxy]</span> 
 ...
 <li><span class="li-head">nat_source_vip</span> <b>(Alias name: nat-source-vip)</b>  Enable to perform snat on traffic from mappedip to the extip for all egress interfaces. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <ul class="ul-self">
 <li><span class="li-head">ack_delay_exponent</span> <b>(Alias name: ack-delay-exponent)</b>  Support meta variable <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">active_connection_id_limit</span> <b>(Alias name: active-connection-id-limit)</b>  Support meta variable <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">max_ack_delay</span> <b>(Alias name: max-ack-delay)</b>  Support meta variable <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">max_datagram_frame_size</span> <b>(Alias name: max-datagram-frame-size)</b>  Support meta variable <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">max_idle_timeout</span> <b>(Alias name: max-idle-timeout)</b>  Support meta variable <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">max_udp_payload_size</span> <b>(Alias name: max-udp-payload-size)</b>  Support meta variable <span class="li-normal">type: int</span>
