:source: fmgr_mpskprofile_mpskgroup_mpskkey.py

:orphan:

.. _fmgr_mpskprofile_mpskgroup_mpskkey:
...
.. raw:: html
 ...
 <li><span class="li-head">mpsk-profile</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">mpsk-group</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">mpskprofile_mpskgroup_mpskkey</span> - List of multiple PSK entries. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
