:source: fmgr_system_npu_ipreassembly.py

:orphan:

.. _fmgr_system_npu_ipreassembly:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_ipreassembly</span> - IP reassebmly engine configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
