...
.. warning::
  Most attributes are read-only and can only be changed internally.
  Please use fmgr_dvm_cmd_add_device/fmgr_dvm_cmd_del_device to add/delete a device.
  Use fmgr_dvm_cmd_add_devlist/fmgr_dvm_cmd_del_devlist to add/delete multiple devices.
