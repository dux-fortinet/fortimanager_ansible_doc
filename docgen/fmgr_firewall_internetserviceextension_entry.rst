:source: fmgr_firewall_internetserviceextension_entry.py

:orphan:

.. _fmgr_firewall_internetserviceextension_entry:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_internetserviceextension_entry</span> - Entries added to the Internet Service extension database. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
