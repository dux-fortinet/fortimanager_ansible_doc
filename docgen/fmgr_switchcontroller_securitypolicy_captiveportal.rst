:source: fmgr_switchcontroller_securitypolicy_captiveportal.py

:orphan:

.. _fmgr_switchcontroller_securitypolicy_captiveportal:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_securitypolicy_captiveportal</span> - Names of VLANs that use captive portal authentication. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">policy_type</span> <b>(Alias name: policy-type)</b>  Policy type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [captive-portal]</span> 
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> v6.2.1</code></p>
 </div>
 </li>
 <li><span class="li-head">vlan</span> Names of vlans that use captive portal authentication. <span class="li-normal">type: str</span>
