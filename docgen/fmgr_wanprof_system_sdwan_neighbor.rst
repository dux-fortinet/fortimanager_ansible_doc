:source: fmgr_wanprof_system_sdwan_neighbor.py

:orphan:

.. _fmgr_wanprof_system_sdwan_neighbor:
...
.. raw:: html
 ...
 <li><span class="li-head">wanprof_system_sdwan_neighbor</span> - Create SD-WAN neighbor from BGP neighbor table to control route advertisements according to SLA status. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
