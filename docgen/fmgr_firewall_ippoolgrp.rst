:source: fmgr_firewall_ippoolgrp.py

:orphan:

.. _fmgr_firewall_ippoolgrp:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_ippoolgrp</span> - Configure IPv4 pool groups. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">member</span> Member ip pool of the group (they must have same attributes except public/client ranges). <span class="li-normal">type: list or str</span>
