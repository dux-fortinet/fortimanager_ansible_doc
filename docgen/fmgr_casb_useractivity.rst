:source: fmgr_casb_useractivity.py
...
.. raw:: html
 ...
 <li><span class="li-head">category</span> Casb user activity category. <span class="li-normal">type: str</span> <span class="li-normal">choices: [activity-control, tenant-control, domain-control, safe-search-control, other, advanced-tenant-control]</span>
 <a id='label4' href="javascript:ContentClick('label5', 'label4');" onmouseover="ContentPreview('label5');" onmouseout="ContentUnpreview('label5');" title="click to collapse or expand..."> more... </a>
 <div id="label5" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">control_options</span> <b>(Alias name: control-options)</b>  Control options. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">operations</span> Operations. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">values</span> Casb operation new values. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">rules</span> Rules. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">domains</span> Casb user activity domain list. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">methods</span> Casb user activity method list. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">tenant_extraction</span> <b>(Alias name: tenant-extraction)</b>  Tenant extraction. <span class="li-normal">type: dict</span>
 ...
 <li><span class="li-head">header_name</span> <b>(Alias name: header-name)</b>  Casb tenant extraction filter header name. <span class="li-normal">type: str</span>
 <a id='label76' href="javascript:ContentClick('label77', 'label76');" onmouseover="ContentPreview('label77');" onmouseout="ContentUnpreview('label77');" title="click to collapse or expand..."> more... </a>
 <div id="label77" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.6.2 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">id</span> Casb tenant extraction filter id. <span class="li-normal">type: int</span>
