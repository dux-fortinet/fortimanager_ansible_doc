:source: fmgr_switchcontroller_managedswitch_ipsourceguard_bindingentry.py

:orphan:

.. _fmgr_switchcontroller_managedswitch_ipsourceguard_bindingentry:
...
.. raw:: html
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.4.0 -> v6.4.1</code></p>
...
.. raw:: html
 ...
 <li><span class="li-head">ip_source_guard</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">switchcontroller_managedswitch_ipsourceguard_bindingentry</span> - IP and MAC address configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
