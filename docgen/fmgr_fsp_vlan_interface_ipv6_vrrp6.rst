:source: fmgr_fsp_vlan_interface_ipv6_vrrp6.py

:orphan:

.. _fmgr_fsp_vlan_interface_ipv6_vrrp6:
...
.. raw:: html
 ...
 <li><span class="li-head">fsp_vlan_interface_ipv6_vrrp6</span> - IPv6 VRRP configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
