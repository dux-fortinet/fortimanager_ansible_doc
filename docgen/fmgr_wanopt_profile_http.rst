:source: fmgr_wanopt_profile_http.py

:orphan:

.. _fmgr_wanopt_profile_http:
...
.. raw:: html
 ...
 <li><span class="li-head">wanopt_profile_http</span> - Enable/disable HTTP WAN Optimization and configure HTTP WAN Optimization features. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">ssl</span> Enable/disable ssl/tls offloading (hardware acceleration) for https traffic in this tunnel. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
