:source: fmgr_system_replacemsggroup_icap.py

:orphan:

.. _fmgr_system_replacemsggroup_icap:
...
.. raw:: html
 ...
 <li><span class="li-head">system_replacemsggroup_icap</span> - Replacement message table entries. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
