:source: fmgr_dnsfilter_profile_ftgddns.py

:orphan:

.. _fmgr_dnsfilter_profile_ftgddns:
...
.. raw:: html
 ...
 <li><span class="li-head">dnsfilter_profile_ftgddns</span> - FortiGuard DNS Filter settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
