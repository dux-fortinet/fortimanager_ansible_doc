:source: fmgr_dnsfilter_profile_domainfilter.py

:orphan:

.. _fmgr_dnsfilter_profile_domainfilter:
...
.. raw:: html
 ...
 <li><span class="li-head">dnsfilter_profile_domainfilter</span> - Domain filter settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
