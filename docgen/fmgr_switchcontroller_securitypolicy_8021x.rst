:source: fmgr_switchcontroller_securitypolicy_8021x.py
...
.. raw:: html
 ...
 <li><span class="li-head">auth_fail_vlan_id</span> <b>(Alias name: auth-fail-vlan-id)</b>  Vlan id on which authentication failed. <span class="li-normal">type: str</span>
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">auth_fail_vlanid</span> <b>(Alias name: auth-fail-vlanid)</b>  Vlan id on which authentication failed. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">guest_auth_delay</span> <b>(Alias name: guest-auth-delay)</b>  Guest authentication delay (1 - 900  sec, default = 30). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">guest_vlan_id</span> <b>(Alias name: guest-vlan-id)</b>  Guest vlan name. <span class="li-normal">type: str</span>
 <a id='label12' href="javascript:ContentClick('label13', 'label12');" onmouseover="ContentPreview('label13');" onmouseout="ContentUnpreview('label13');" title="click to collapse or expand..."> more... </a>
 <div id="label13" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">guest_vlanid</span> <b>(Alias name: guest-vlanid)</b>  Guest vlan id. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">user_group</span> <b>(Alias name: user-group)</b>  Name of user-group to assign to this mac authentication bypass (mab) policy. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">authserver_timeout_period</span> <b>(Alias name: authserver-timeout-period)</b>  Authentication server timeout period (3 - 15 sec, default = 3). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">authserver_timeout_vlanid</span> <b>(Alias name: authserver-timeout-vlanid)</b>  Authentication server timeout vlan name. <span class="li-normal">type: str</span>
