:source: fmgr_pkg_firewall_policy_fabricpolicy.py

:orphan:

.. _fmgr_pkg_firewall_policy_fabricpolicy:

fmgr_pkg_firewall_policy_fabricpolicy -- Fabric policy related attributes.
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
.. raw:: html
 ...
 <li><span class="li-head">pkg_firewall_policy_fabricpolicy</span> - Fabric policy related attributes. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">from</span> From device. <span class="li-normal">type: list</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v8.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">to</span> To device. <span class="li-normal">type: list</span>
...
.. code-block:: yaml+jinja
  ...
  - name: Example playbook (generated based on argument schema)
    ...
    gather_facts: false
    tasks:
      - name: Fabric policy related attributes.
        fortinet.fortimanager.fmgr_pkg_firewall_policy_fabricpolicy:
          # workspace_locking_adom: <global or your adom name>
          adom: <your own value>
          pkg: <your own value>
          policy: <your own value>
          pkg_firewall_policy_fabricpolicy:
            # from: <list or string>
            # to: <list or string>
