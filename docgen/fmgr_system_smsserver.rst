...
.. raw:: html
 ...
 <li><span class="li-head">system_smsserver</span> - Configure SMS server for sending SMS messages to support user authentication. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">mail_server</span> <b>(Alias name: mail-server)</b>  Email-to-sms server domain name. <span class="li-normal">type: str</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">name</span> Name of sms server. <span class="li-normal">type: str</span>
