:source: fmgr_firewall_trafficclass.py

:orphan:

.. _fmgr_firewall_trafficclass:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_trafficclass</span> - Configure names for shaping classes. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">class_id</span> <b>(Alias name: class-id)</b>  Class id to be named. <span class="li-normal">type: int</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.2.2 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">class_name</span> <b>(Alias name: class-name)</b>  Define the name for this class-id. <span class="li-normal">type: str</span>
