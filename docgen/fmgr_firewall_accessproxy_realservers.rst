:source: fmgr_firewall_accessproxy_realservers.py

:orphan:

.. _fmgr_firewall_accessproxy_realservers:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_accessproxy_realservers</span> - Select the SSL real servers that this Access Proxy will distribute traffic to. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
