:source: fmgr_antivirus_profile_ftp.py

:orphan:

.. _fmgr_antivirus_profile_ftp:
...
.. raw:: html
 ...
 <li><span class="li-head">antivirus_profile_ftp</span> - Configure FTP AntiVirus options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
