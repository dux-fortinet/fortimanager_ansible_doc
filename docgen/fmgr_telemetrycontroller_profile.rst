:source: fmgr_telemetrycontroller_profile.py

:orphan:

.. _fmgr_telemetrycontroller_profile:
...
.. raw:: html
 ...
 <li><span class="li-head">telemetrycontroller_profile</span> - Configure FortiTelemetry profiles. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <ul class="ul-self">
 <li><span class="li-head">app_name</span> <b>(Alias name: app-name)</b>  Application name. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">interval</span> Time in milliseconds to check the application (1000 - 86,400 * 1000, default = 300 * 1000 ms). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">name</span> Name of the profile. <span class="li-normal">type: str</span>
