:source: fmgr_system_npu_portcpumap.py

:orphan:

.. _fmgr_system_npu_portcpumap:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_portcpumap</span> - Configure NPU interface to CPU core mapping. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
