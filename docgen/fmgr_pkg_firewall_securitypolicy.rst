:source: fmgr_pkg_firewall_securitypolicy.py

:orphan:

.. _fmgr_pkg_firewall_securitypolicy:
...
.. raw:: html
 ...
 <li><span class="li-head">pkg_firewall_securitypolicy</span> - Configure NGFW IPv4/IPv6 application policies. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.2.1 -> v7.2.0</code>, <code class="docutils literal notranslate">v7.2.6 -> v7.2.11</code>, <code class="docutils literal notranslate">v7.4.3 -> v7.6.2</code></p>
 </div>
 </li>
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.2.1 -> v7.2.2</code>, <code class="docutils literal notranslate">v7.2.4 -> v7.2.4</code>, <code class="docutils literal notranslate">v7.2.6 -> v7.2.11</code>, <code class="docutils literal notranslate">v7.4.2 -> latest</code></p>
 </div>
 </li>
 ...
 <li><span class="li-head">dstaddr</span> Destination ipv4 address name and address group names. <span class="li-normal">type: list or str</span>
 ...
 <li><span class="li-head">srcaddr</span> Source ipv4 address name and address group names. <span class="li-normal">type: list or str</span>
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.1 -> v7.2.1</code>, <code class="docutils literal notranslate">v7.2.4 -> v7.2.4</code>, <code class="docutils literal notranslate">v7.2.6 -> v7.2.11</code>, <code class="docutils literal notranslate">v7.4.2 -> latest</code></p>
 </div>
 </li>
