:source: fmgr_system_sdnconnector_route.py

:orphan:

.. _fmgr_system_sdnconnector_route:
...
.. raw:: html
 ...
 <li><span class="li-head">system_sdnconnector_route</span> - Configure GCP route. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
