:source: fmgr_dnsfilter_domainfilter.py

:orphan:

.. _fmgr_dnsfilter_domainfilter:
...
.. raw:: html
 ...
 <li><span class="li-head">dnsfilter_domainfilter</span> - Configure DNS domain filters. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
