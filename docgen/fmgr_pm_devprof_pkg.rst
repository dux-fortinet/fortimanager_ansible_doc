:source: fmgr_pm_devprof_pkg.py

:orphan:

.. _fmgr_pm_devprof_pkg:
...
.. raw:: html
 ...
 <li><span class="li-head">pm_devprof_pkg</span> - System template adom <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">enabled_options</span> <b>(Alias name: enabled options)</b>  Enabled options. <span class="li-normal">type: list</span> <span class="li-normal">choices: [none, dns, ntp, email, admin, snmp, repmsg, ftgd, log]</span> 
 ...
 <li><span class="li-head">type</span> Type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [devprof]</span> 
