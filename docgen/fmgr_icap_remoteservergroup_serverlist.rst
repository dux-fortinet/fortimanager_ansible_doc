:source: fmgr_icap_remoteservergroup_serverlist.py

:orphan:

.. _fmgr_icap_remoteservergroup_serverlist:
...
.. raw:: html
 ...
 <li><span class="li-head">remote_server_group</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">icap_remoteservergroup_serverlist</span> - Icap remote server group server list <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">name</span> Name. <span class="li-normal">type: list</span>
