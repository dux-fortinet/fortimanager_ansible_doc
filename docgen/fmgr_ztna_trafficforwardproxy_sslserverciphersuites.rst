:source: fmgr_ztna_trafficforwardproxy_sslserverciphersuites.py

:orphan:

.. _fmgr_ztna_trafficforwardproxy_sslserverciphersuites:
...
.. raw:: html
 ...
 <li><span class="li-head">ztna_trafficforwardproxy_sslserverciphersuites</span> - Ztna traffic forward proxy ssl server cipher suites <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
