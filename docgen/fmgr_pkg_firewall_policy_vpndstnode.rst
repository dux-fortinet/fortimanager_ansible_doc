:source: fmgr_pkg_firewall_policy_vpndstnode.py

:orphan:

.. _fmgr_pkg_firewall_policy_vpndstnode:
...
.. raw:: html
 ...
 <li><span class="li-head">pkg_firewall_policy_vpndstnode</span> - Policy package firewall policy vpn dst node <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
