:source: fmgr_videofilter_youtubechannelfilter_entries.py

:orphan:

.. _fmgr_videofilter_youtubechannelfilter_entries:
...
.. raw:: html
 ...
 <li><span class="li-head">youtube_channel_filter</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">videofilter_youtubechannelfilter_entries</span> - YouTube filter entries. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">channel_id</span> <b>(Alias name: channel-id)</b>  Channel id. <span class="li-normal">type: str</span>
