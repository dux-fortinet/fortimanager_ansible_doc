:source: fmgr_vap_macfilterlist.py

:orphan:

.. _fmgr_vap_macfilterlist:
...
.. raw:: html
 ...
 <li><span class="li-head">vap_macfilterlist</span> - Create a list of MAC addresses for MAC address filtering. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
