:source: fmgr_system_npu_dswdtsprofile.py

:orphan:

.. _fmgr_system_npu_dswdtsprofile:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_dswdtsprofile</span> - Configure NPU DSW DTS profile. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
