:source: fmgr_emailfilter_options.py

:orphan:

.. _fmgr_emailfilter_options:
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">dns_timeout</span> <b>(Alias name: dns-timeout)</b>  Dns query time out (1 - 30 sec). <span class="li-normal">type: int</span>
