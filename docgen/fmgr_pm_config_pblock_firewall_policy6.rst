:source: fmgr_pm_config_pblock_firewall_policy6.py

:orphan:

.. _fmgr_pm_config_pblock_firewall_policy6:
...
.. raw:: html
 ...
 <li><span class="li-head">pm_config_pblock_firewall_policy6</span> - Configure IPv6 policies. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">cgn_log_server_grp</span> <b>(Alias name: cgn-log-server-grp)</b>  Cgn log server grp. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">custom_log_fields</span> <b>(Alias name: custom-log-fields)</b>  Log field index numbers to append custom log fields to log messages for this policy. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">policy_offload</span> <b>(Alias name: policy-offload)</b>  Policy offload. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.0.3 -> v7.2.1</code>, <code class="docutils literal notranslate">v7.2.6 -> v7.2.12</code>, <code class="docutils literal notranslate">v7.4.3 -> v7.6.2</code></p>
 </div>
 </li>
 ...
 <li><span class="li-head">session_ttl</span> <b>(Alias name: session-ttl)</b>  Session ttl in seconds for sessions accepted by this policy. <span class="li-normal">type: str</span>
