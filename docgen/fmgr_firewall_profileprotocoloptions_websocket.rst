:source: fmgr_firewall_profileprotocoloptions_websocket.py

:orphan:

.. _fmgr_firewall_profileprotocoloptions_websocket:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_profileprotocoloptions_websocket</span> - Configure WebSocket protocol options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
