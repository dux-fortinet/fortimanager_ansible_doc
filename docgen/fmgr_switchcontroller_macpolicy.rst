:source: fmgr_switchcontroller_macpolicy.py

:orphan:

.. _fmgr_switchcontroller_macpolicy:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_macpolicy</span> - Configure MAC policy to be applied on the managed FortiSwitch devices through NAC device. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">bounce_port_link</span> <b>(Alias name: bounce-port-link)</b>  Enable/disable bouncing (administratively bring the link down, up) of a switch port where this mac-policy is applied. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">name</span> Mac policy name. <span class="li-normal">type: str</span>
 <a id='label6' href="javascript:ContentClick('label7', 'label6');" onmouseover="ContentPreview('label7');" onmouseout="ContentUnpreview('label7');" title="click to collapse or expand..."> more... </a>
 <div id="label7" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">traffic_policy</span> <b>(Alias name: traffic-policy)</b>  Traffic policy to be applied when using this mac policy. <span class="li-normal">type: str</span>
 <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
 <div id="label9" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">vlan</span> Ingress traffic vlan assignment for the mac address matching this mac policy. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">poe_reset</span> <b>(Alias name: poe-reset)</b>  Enable/disable poe reset of a switch port where this mac-policy is applied. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
