:source: fmgr_pm_config_pblock_firewall_consolidated_policy_sectionvalue.py

:orphan:

.. _fmgr_pm_config_pblock_firewall_consolidated_policy_sectionvalue:
...
.. raw:: html
 ...
 <li><span class="li-head">pm_config_pblock_firewall_consolidated_policy_sectionvalue</span> - Configure consolidated IPv4/IPv6 policies. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
