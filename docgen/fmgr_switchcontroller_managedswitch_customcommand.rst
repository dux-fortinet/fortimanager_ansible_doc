:source: fmgr_switchcontroller_managedswitch_customcommand.py

:orphan:

.. _fmgr_switchcontroller_managedswitch_customcommand:
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_managedswitch_customcommand</span> - Configuration method to edit FortiSwitch commands to be pushed to this FortiSwitch device upon rebooting the FortiGate switch contro... <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
