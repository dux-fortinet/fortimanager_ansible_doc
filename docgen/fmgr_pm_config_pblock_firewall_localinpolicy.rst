:source: fmgr_pm_config_pblock_firewall_localinpolicy.py

:orphan:

.. _fmgr_pm_config_pblock_firewall_localinpolicy:
...
.. raw:: html
 ...
 <li><span class="li-head">pm_config_pblock_firewall_localinpolicy</span> - Configure user defined IPv4 local-in policies. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
