:source: fmgr_system_npu_portnpumap.py

:orphan:

.. _fmgr_system_npu_portnpumap:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_portnpumap</span> - Configure port to NPU group mapping. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
