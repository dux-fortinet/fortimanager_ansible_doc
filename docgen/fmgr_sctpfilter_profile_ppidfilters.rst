:source: fmgr_sctpfilter_profile_ppidfilters.py

:orphan:

.. _fmgr_sctpfilter_profile_ppidfilters:
...
.. raw:: html
 ...
 <li><span class="li-head">sctpfilter_profile_ppidfilters</span> - PPID filters list. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
