:source: fmgr_firewall_mmsprofile_outbreakprevention.py

:orphan:

.. _fmgr_firewall_mmsprofile_outbreakprevention:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_mmsprofile_outbreakprevention</span> - Configure Virus Outbreak Prevention settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
