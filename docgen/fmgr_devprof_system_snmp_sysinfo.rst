:source: fmgr_devprof_system_snmp_sysinfo.py

:orphan:

.. _fmgr_devprof_system_snmp_sysinfo:
...
.. raw:: html
 ...
 <li><span class="li-head">devprof_system_snmp_sysinfo</span> - SNMP system info configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">append_index</span> <b>(Alias name: append-index)</b>  Enable/disable allowance of appending vdom or interface index in some rfc tables. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span> 
 ...
 <li><span class="li-head">engine_id</span> <b>(Alias name: engine-id)</b>  Local snmp engineid string (maximum 27 characters). <span class="li-normal">type: str</span>
 <a id='label8' href="javascript:ContentClick('label9', 'label8');" onmouseover="ContentPreview('label9');" onmouseout="ContentUnpreview('label9');" title="click to collapse or expand..."> more... </a>
 <div id="label9" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.6 -> v7.2.11</code>, <code class="docutils literal notranslate">v7.4.3 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">trap_freeable_memory_threshold</span> <b>(Alias name: trap-freeable-memory-threshold)</b>  Freeable memory usage when trap is sent. <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">engine_id_type</span> <b>(Alias name: engine-id-type)</b>  Local snmp engineid type (text/hex/mac). <span class="li-normal">type: str</span> <span class="li-normal">choices: [text, hex, mac]</span> 
 ...
 <li><span class="li-head">trap_free_memory_threshold</span> <b>(Alias name: trap-free-memory-threshold)</b>  Free memory usage when trap is sent. <span class="li-normal">type: int</span>
