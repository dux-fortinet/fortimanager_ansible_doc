:source: fmgr_system_sdnconnector_compartmentlist.py

:orphan:

.. _fmgr_system_sdnconnector_compartmentlist:
...
.. raw:: html
 ...
 <li><span class="li-head">system_sdnconnector_compartmentlist</span> - Configure OCI compartment list. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
