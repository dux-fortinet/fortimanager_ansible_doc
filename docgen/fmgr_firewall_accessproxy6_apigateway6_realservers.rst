:source: fmgr_firewall_accessproxy6_apigateway6_realservers.py

:orphan:

.. _fmgr_firewall_accessproxy6_apigateway6_realservers:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_accessproxy6_apigateway6_realservers</span> - Select the real servers that this Access Proxy will distribute traffic to. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
