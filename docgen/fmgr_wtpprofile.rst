...
.. raw:: html
 ...
 <li><span class="li-head">apcfg_auto_cert</span> <b>(Alias name: apcfg-auto-cert)</b>  Enable/disable ap local auto cert configuration (default = disable). <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_auto_regen_days</span> <b>(Alias name: apcfg-auto-cert-auto-regen-days)</b>  Number of days to wait before expiry of an updated local certificate is requested (0 = disabled) (default = 30). <span class="li-normal">type: int</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_crypto_algo</span> <b>(Alias name: apcfg-auto-cert-crypto-algo)</b>  Cryptography algorithm: rsa-1024, rsa-1536, rsa-2048, rsa-4096, ec-secp256r1, ec-secp384r1, ec-secp521r1 (default = ec-secp256r1) <span class="li-normal">type: str</span> <span class="li-normal">choices: [rsa-1024, rsa-1536, rsa-2048, rsa-4096, ec-secp256r1, ec-secp384r1, ec-secp521r1]</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_enroll_protocol</span> <b>(Alias name: apcfg-auto-cert-enroll-protocol)</b>  Certificate enrollment protocol (default = none) <span class="li-normal">type: str</span> <span class="li-normal">choices: [none, scep, est]</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_est_ca_id</span> <b>(Alias name: apcfg-auto-cert-est-ca-id)</b>  Ca identifier of the ca server for signing via est. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_est_http_password</span> <b>(Alias name: apcfg-auto-cert-est-http-password)</b>  Http authentication password for signing via est. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_est_http_username</span> <b>(Alias name: apcfg-auto-cert-est-http-username)</b>  Http authentication username for signing via est. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_est_https_ca</span> <b>(Alias name: apcfg-auto-cert-est-https-ca)</b>  Pem format https ca certificate. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_est_server</span> <b>(Alias name: apcfg-auto-cert-est-server)</b>  Address and port for est server (e. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_est_subject</span> <b>(Alias name: apcfg-auto-cert-est-subject)</b>  Subject e. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_est_subject_alt_name</span> <b>(Alias name: apcfg-auto-cert-est-subject-alt-name)</b>  Subject alternative name (optional, e. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_scep_ca_id</span> <b>(Alias name: apcfg-auto-cert-scep-ca-id)</b>  Ca identifier of the ca server for signing via scep. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_scep_ec_name</span> <b>(Alias name: apcfg-auto-cert-scep-ec-name)</b>  Elliptic curve name: secp256r1, secp384r1 and secp521r1. <span class="li-normal">type: str</span> <span class="li-normal">choices: [secp256r1, secp384r1, secp521r1]</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_scep_https_ca</span> <b>(Alias name: apcfg-auto-cert-scep-https-ca)</b>  Pem format https ca certificate. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_scep_keysize</span> <b>(Alias name: apcfg-auto-cert-scep-keysize)</b>  Key size: 1024, 1536, 2048, 4096 (default 2048). <span class="li-normal">type: str</span> <span class="li-normal">choices: [1024, 1536, 2048, 4096]</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_scep_keytype</span> <b>(Alias name: apcfg-auto-cert-scep-keytype)</b>  Key type (default = rsa) <span class="li-normal">type: str</span> <span class="li-normal">choices: [rsa, ec]</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_scep_password</span> <b>(Alias name: apcfg-auto-cert-scep-password)</b>  Scep server challenge password for auto-regeneration. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_scep_sub_fully_dn</span> <b>(Alias name: apcfg-auto-cert-scep-sub-fully-dn)</b>  Full dn of the subject (e. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_scep_subject_alt_name</span> <b>(Alias name: apcfg-auto-cert-scep-subject-alt-name)</b>  Subject alternative name (optional, e. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">apcfg_auto_cert_scep_url</span> <b>(Alias name: apcfg-auto-cert-scep-url)</b>  Scep server url. <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">lw_profile</span> <b>(Alias name: lw-profile)</b>  Lorawan profile name. <span class="li-normal">type: list</span>
