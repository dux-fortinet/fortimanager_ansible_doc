:source: fmgr_dlp_fpsensitivity.py

:orphan:

.. _fmgr_dlp_fpsensitivity:
...
.. raw:: html
 ...
 <li><span class="li-head">dlp_fpsensitivity</span> - Create self-explanatory DLP sensitivity levels to be used when setting sensitivity under config fp-doc-source. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">name</span> Dlp sensitivity levels. <span class="li-normal">type: str</span>
