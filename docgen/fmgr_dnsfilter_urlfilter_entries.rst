:source: fmgr_dnsfilter_urlfilter_entries.py

:orphan:

.. _fmgr_dnsfilter_urlfilter_entries:
...
.. raw:: html
 ...
 <li><span class="li-head">dnsfilter_urlfilter_entries</span> - DNS URL filter. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">action</span> Action to take for filter matches. <span class="li-normal">type: str</span> <span class="li-normal">choices: [allow, monitor, block]</span> 
 ...
 <li><span class="li-head">type</span> Filter type. <span class="li-normal">type: str</span> <span class="li-normal">choices: [wildcard, regex, simple]</span> 
 <a id='label6' href="javascript:ContentClick('label7', 'label6');" onmouseover="ContentPreview('label7');" onmouseout="ContentUnpreview('label7');" title="click to collapse or expand..."> more... </a>
 <div id="label7" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.2.0 -> v6.2.13</code></p>
 </div>
 </li>
 <li><span class="li-head">url</span> Url entries to be filtered. <span class="li-normal">type: str</span>
