:source: fmgr_dnsfilter_urlfilter.py

:orphan:

.. _fmgr_dnsfilter_urlfilter:
...
.. raw:: html
 ...
 <li><span class="li-head">dnsfilter_urlfilter</span> - Configure URL filter list. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
