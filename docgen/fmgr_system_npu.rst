...
.. raw:: html
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.2.5 -> v7.2.12</code>, <code class="docutils literal notranslate">v7.4.3 -> latest</code></p>
 </div>
 </li>
 </ul>
 </li>
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.0.9 -> v7.0.16</code>, <code class="docutils literal notranslate">v7.2.4 -> v7.2.12</code>, <code class="docutils literal notranslate">v7.4.2 -> latest</code></p>
 </div>
 </li>
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.0.12 -> v7.0.16</code>, <code class="docutils literal notranslate">v7.2.6 -> v7.2.12</code>, <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 </li>
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.4.9 -> v6.4.15</code>, <code class="docutils literal notranslate">v7.0.4 -> v7.0.16</code>, <code class="docutils literal notranslate">v7.2.1 -> latest</code></p>
 </div>
 </li>
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.4.10 -> v6.4.15</code>, <code class="docutils literal notranslate">v7.0.4 -> v7.0.16</code>, <code class="docutils literal notranslate">v7.2.1 -> latest</code></p>
 </div>
 <ul class="ul-self">
 ...
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.0.12 -> v7.0.16</code>, <code class="docutils literal notranslate">v7.2.6 -> v7.2.12</code>, <code class="docutils literal notranslate">v7.4.2 -> latest</code></p>
 </div>
 </li>
 ...
 <li><span class="li-head">use_mse_oft</span> <b>(Alias name: use-mse-oft)</b>  Enable/disable use of mse oft. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>
 ...
 <li><span class="li-head">ike_port</span> <b>(Alias name: ike-port)</b>  Configure additional ipsec ports for offloading. <span class="li-normal">type: list</span>
 ...
 <li><span class="li-head">mcast_denied_ses_offload</span> <b>(Alias name: mcast-denied-ses-offload)</b>  Enable/disable offloading of multicast denied sessions. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>
 ...
 <li><span class="li-head">shadow_virtual_switch</span> <b>(Alias name: shadow-virtual-switch)</b>  Enable/disable shadow virtual switch. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>
 ...
 <li><span class="li-head">use_ixgbe_tx</span> <b>(Alias name: use-ixgbe-tx)</b>  Enable/disable use of the ixgbe nic for transmitting packets (default = enable). <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>
 ...
 <li><span class="li-head">vxlan_mac_flapping_guard</span> <b>(Alias name: vxlan-mac-flapping-guard)</b>  Enable/disable vxlan mac flapping guard. <span class="li-normal">type: str</span> <span class="li-normal">choices: [disable, enable]</span>
