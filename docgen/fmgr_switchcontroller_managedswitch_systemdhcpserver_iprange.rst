:source: fmgr_switchcontroller_managedswitch_systemdhcpserver_iprange.py

:orphan:

.. _fmgr_switchcontroller_managedswitch_systemdhcpserver_iprange:
...
.. raw:: html
 ...
 <li><span class="li-head">system_dhcp_server</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 <li><span class="li-head">switchcontroller_managedswitch_systemdhcpserver_iprange</span> - DHCP IP range configuration. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
