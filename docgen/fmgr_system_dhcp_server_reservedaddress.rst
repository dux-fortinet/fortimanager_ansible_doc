...
.. raw:: html
 ...
 <li><span class="li-head">system_dhcp_server_reservedaddress</span> - Options for the DHCP server to assign IP settings to specific MAC addresses. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
