:source: fmgr_application_list_defaultnetworkservices.py

:orphan:

.. _fmgr_application_list_defaultnetworkservices:
...
.. raw:: html
 ...
 <li><span class="li-head">application_list_defaultnetworkservices</span> - Default network service entries. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
