:source: fmgr_antivirus_profile_imap.py

:orphan:

.. _fmgr_antivirus_profile_imap:
...
.. raw:: html
 ...
 <li><span class="li-head">antivirus_profile_imap</span> - Configure IMAP AntiVirus options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
