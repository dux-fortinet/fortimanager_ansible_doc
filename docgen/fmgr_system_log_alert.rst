:source: fmgr_system_log_alert.py

:orphan:

.. _fmgr_system_log_alert:
...
.. raw:: html
 ...
 <li><span class="li-head">system_log_alert</span> - Log based alert settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">max_alert_count</span> <b>(Alias name: max-alert-count)</b>  Maximum number of alerts supported. <span class="li-normal">type: int</span> <span class="li-normal">default: 1000</span>
