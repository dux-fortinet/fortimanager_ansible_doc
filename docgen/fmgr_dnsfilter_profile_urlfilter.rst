:source: fmgr_dnsfilter_profile_urlfilter.py

:orphan:

.. _fmgr_dnsfilter_profile_urlfilter:
...
.. raw:: html
 ...
 <li><span class="li-head">dnsfilter_profile_urlfilter</span> - URL filter settings. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
