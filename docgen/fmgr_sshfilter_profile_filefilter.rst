:source: fmgr_sshfilter_profile_filefilter.py

:orphan:

.. _fmgr_sshfilter_profile_filefilter:
...
.. raw:: html
 ...
 <li><span class="li-head">sshfilter_profile_filefilter</span> - File filter. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
