:source: fmgr_switchcontroller_qos_dot1pmap.py
...
.. raw:: html
 ...
 <li><span class="li-head">switchcontroller_qos_dot1pmap</span> - Configure FortiSwitch QoS 802. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">description</span> Description of the 802. <span class="li-normal">type: str</span>
 <a id='label0' href="javascript:ContentClick('label1', 'label0');" onmouseover="ContentPreview('label1');" onmouseout="ContentUnpreview('label1');" title="click to collapse or expand..."> more... </a>
 <div id="label1" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">name</span> Dot1p map name. <span class="li-normal">type: str</span>
