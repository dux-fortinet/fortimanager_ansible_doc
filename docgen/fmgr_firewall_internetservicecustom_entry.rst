...
.. raw:: html
 ...
 <li><span class="li-head">firewall_internetservicecustom_entry</span> - Entries added to the Internet Service database and custom database. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
