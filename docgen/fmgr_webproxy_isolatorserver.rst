:source: fmgr_webproxy_isolatorserver.py

:orphan:

.. _fmgr_webproxy_isolatorserver:
...
.. raw:: html
 ...
 <li><span class="li-head">webproxy_isolatorserver</span> - Configure forward-server addresses. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 <li><span class="li-head">addr_type</span> <b>(Alias name: addr-type)</b>  Address type of the forwarding proxy server: ip or fqdn. <span class="li-normal">type: str</span> <span class="li-normal">choices: [fqdn, ipv6, ip]</span> 
