:source: fmgr_system_alertconsole.py

:orphan:

.. _fmgr_system_alertconsole:
...
.. raw:: html
 ...
 <li><span class="li-head">severity_level</span> <b>(Alias name: severity-level)</b>  Alert console keeps alerts of this and higher severity. <span class="li-normal">type: list</span> <span class="li-normal">choices: [debug, information, notify, warning, error, critical, alert, emergency]</span>
