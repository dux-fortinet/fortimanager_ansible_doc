:source: fmgr_firewall_accessproxysshclientcert.py

:orphan:

.. _fmgr_firewall_accessproxysshclientcert:
...
.. raw:: html
 ...
 <li><span class="li-head">firewall_accessproxysshclientcert</span> - Configure Access Proxy SSH client certificate. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">name</span> Ssh client certificate name. <span class="li-normal">type: str</span>
