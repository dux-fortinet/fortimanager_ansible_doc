:source: fmgr_wanopt_profile_ftp.py

:orphan:

.. _fmgr_wanopt_profile_ftp:
...
.. raw:: html
 ...
 <li><span class="li-head">wanopt_profile_ftp</span> - Enable/disable FTP WAN Optimization and configure FTP WAN Optimization features. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
