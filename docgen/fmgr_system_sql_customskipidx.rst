:source: fmgr_system_sql_customskipidx.py

:orphan:

.. _fmgr_system_sql_customskipidx:
...
.. raw:: html
 ...
 <li><span class="li-head">system_sql_customskipidx</span> - List of aditional SQL skip index fields. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
