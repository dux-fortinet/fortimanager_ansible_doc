:source: fmgr_antivirus_profile_websocket.py

:orphan:

.. _fmgr_antivirus_profile_websocket:
...
.. raw:: html
 ...
 <li><span class="li-head">antivirus_profile_websocket</span> - Configure WEBSOCKET AntiVirus options. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
