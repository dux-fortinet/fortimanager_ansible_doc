:source: fmgr_fmupdate_customurllist.py

:orphan:

.. _fmgr_fmupdate_customurllist:
...
.. raw:: html
 ...
 <ul class="ul-self">
 <li><span class="li-head">db_selection</span> Manage the url database (default = both). <span class="li-normal">type: list</span> <span class="li-normal">choices: [both, custom-url, fortiguard-db]</span>
