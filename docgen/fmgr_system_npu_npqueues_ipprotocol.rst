:source: fmgr_system_npu_npqueues_ipprotocol.py

:orphan:

.. _fmgr_system_npu_npqueues_ipprotocol:
...
.. raw:: html
 ...
 <li><span class="li-head">system_npu_npqueues_ipprotocol</span> - Configure a NP7 QoS IP Protocol. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
