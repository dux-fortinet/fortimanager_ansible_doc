:source: fmgr_dvmdb_workspace_unlock_pkg.py

:orphan:

.. _fmgr_dvmdb_workspace_unlock_pkg:
...
.. raw:: html
 ...
 <li><span class="li-head">package_path_name</span> - The parameter in requested url <span class="li-normal">type: str</span> <span class="li-required">required: true</span> </li>
 </ul>
