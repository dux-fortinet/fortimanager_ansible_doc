:source: fmgr_securityconsole_preview_result.py

:orphan:

.. _fmgr_securityconsole_preview_result:
...
.. raw:: html
 ...
 <li><span class="li-head">securityconsole_preview_result</span> - Retrieve the result of previous install/preview command. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
