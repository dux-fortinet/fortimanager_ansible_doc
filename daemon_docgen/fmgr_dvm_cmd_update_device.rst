:source: fmgr_dvm_cmd_update_device.py

:orphan:

.. _fmgr_dvm_cmd_update_device:
...
.. raw:: html
 ...
 <li><span class="li-head">dvm_cmd_update_device</span> - Refresh the FGFM connection and system information of a device. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">device</span> Name or id of the target device. <span class="li-normal">type: str</span>
