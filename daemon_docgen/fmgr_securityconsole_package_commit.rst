:source: fmgr_securityconsole_package_commit.py

:orphan:

.. _fmgr_securityconsole_package_commit:
...
.. raw:: html
 ...
 <li><span class="li-head">securityconsole_package_commit</span> - Install policies to device from preview cache. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
