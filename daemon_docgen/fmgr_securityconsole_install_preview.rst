:source: fmgr_securityconsole_install_preview.py

:orphan:

.. _fmgr_securityconsole_install_preview:
...
.. raw:: html
 ...
 <li><span class="li-head">securityconsole_install_preview</span> - Generate install preview for a device. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
