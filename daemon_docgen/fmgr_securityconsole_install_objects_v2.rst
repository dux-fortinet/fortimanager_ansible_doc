:source: fmgr_securityconsole_install_objects_v2.py

:orphan:

.. _fmgr_securityconsole_install_objects_v2:
...
.. raw:: html
 ...
 <li><span class="li-head">securityconsole_install_objects_v2</span> - Securityconsole install objects v2 <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">category</span> Category. <span class="li-normal">type: str</span>
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v7.4.1 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">objects</span> Objects. <span class="li-normal">type: list</span>
