:source: fmgr_dvm_cmd_changehaseq.py

:orphan:

.. _fmgr_dvm_cmd_changehaseq:
...
.. raw:: html
 ...
 <li><span class="li-head">dvm_cmd_changehaseq</span> - Modify HA sequence to promote a slave to become the master of the cluster. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">device</span> Name or id of the target ha cluster (original master device). <span class="li-normal">type: str</span>
 ...
 <li><span class="li-head">new_master</span> Name or id of the new ha master. <span class="li-normal">type: str</span>
