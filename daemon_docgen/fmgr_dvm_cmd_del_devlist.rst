:source: fmgr_dvm_cmd_del_devlist.py

:orphan:

.. _fmgr_dvm_cmd_del_devlist:
...
.. raw:: html
 ...
 <li><span class="li-head">del_dev_member_list</span> <b>(Alias name: del-dev-member-list)</b>  Del dev member list. <span class="li-normal">type: list</span>
