...
.. raw:: html
 ...
 <li><span class="li-head">securityconsole_install_device</span> - Securityconsole install device <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">dev_rev_comments</span> Dev rev comments. <span class="li-normal">type: str</span>
 <a id='label2' href="javascript:ContentClick('label3', 'label2');" onmouseover="ContentPreview('label3');" onmouseout="ContentUnpreview('label3');" title="click to collapse or expand..."> more... </a>
 <div id="label3" style="display:none">
 <p>Supported Version Ranges: <code class="docutils literal notranslate">v6.0.0 -> latest</code></p>
 </div>
 </li>
 <li><span class="li-head">flags</span> Preview - generate preview cache only. <span class="li-normal">type: list</span> <span class="li-normal">choices: [none, preview, auto_lock_ws]</span> 
