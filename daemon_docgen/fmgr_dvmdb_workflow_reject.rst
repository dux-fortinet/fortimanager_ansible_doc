:source: fmgr_dvmdb_workflow_reject.py

:orphan:

.. _fmgr_dvmdb_workflow_reject:
...
.. raw:: html
 ...
 <li><span class="li-head">dvmdb_workflow_reject</span> - Device manager database workflow reject <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
