:source: fmgr_dvm_cmd_update_devlist.py

:orphan:

.. _fmgr_dvm_cmd_update_devlist:
...
.. raw:: html
 ...
 <li><span class="li-head">dvm_cmd_update_devlist</span> - Refresh FGFM connection and system information for a list of devices. <span class="li-normal">type: dict</span></li>
 <ul class="ul-self">
 ...
 <li><span class="li-head">update_dev_member_list</span> <b>(Alias name: update-dev-member-list)</b>  Update dev member list. <span class="li-normal">type: list</span>
